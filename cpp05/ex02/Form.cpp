...
void Form::setName(std::string const &_name)
{
    this->_name = _name;
}
...
void Form::setGradeToSign(int _gradeToSign)
{
    this->_gradeToSign = _gradeToSign;
}

void Form::setGradeToExecute(int _gradeToExecute)
{
    this->_gradeToExecute = _gradeToExecute;
}
